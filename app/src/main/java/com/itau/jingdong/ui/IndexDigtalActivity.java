...
public class IndexDigtalActivity extends Activity implements IXListViewListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_index_digital);
		initView();
		//请求网络数据
	...
	private class WareTask extends AsyncTask<Void, Void, HashMap<String, Object>> {
		...
		protected void onPreExecute() {
			if (dialog==null) {
				dialog= ProgressDialog.show(IndexDigtalActivity.this, "", "正在加载...");
				dialog.show();
			}
		}
		...
		protected void onPostExecute(HashMap<String, Object> result) {
			...
			if (result != null && result.get("data") != null) {
				...
				listView.setAdapter(new Adapter_ListView_ware(IndexDigtalActivity.this, arrayList));
				listView.setOnItemClickListener(new OnItemClickListener() {
					@Override
					public void onItemClick(AdapterView<?> arg0, View arg1, int position, long arg3) {
						Intent intent = new Intent(IndexDigtalActivity.this, BabyActivity.class);
						startActivity(intent);
					}
				});

			}else {
				listView.setAdapter(new Adapter_ListView_ware(IndexDigtalActivity.this));
				listView.setOnItemClickListener(new OnItemClickListener() {
					@Override
					public void onItemClick(AdapterView<?> arg0, View arg1, int position, long arg3) {
						Intent intent = new Intent(IndexDigtalActivity.this, BabyActivity.class);
