...
public class IndexClothingActivity extends Activity implements IXListViewListener {
	...
	private class WareTask extends AsyncTask<Void, Void, HashMap<String, Object>> {
		...
		protected void onPreExecute() {
			if (dialog==null) {
				dialog= ProgressDialog.show(IndexClothingActivity.this, "", "正在加载...");
				dialog.show();
			}
		}
		...
		protected void onPostExecute(HashMap<String, Object> result) {
			...
			if (result != null && result.get("data") != null) {
				...
				listView.setAdapter(new Adapter_ListView_ware(IndexClothingActivity.this, arrayList));
				listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
					@Override
					public void onItemClick(AdapterView<?> arg0, View arg1, int position, long arg3) {
						Intent intent = new Intent(IndexClothingActivity.this, BabyActivity.class);
						startActivity(intent);
					}
				});

			}else {
				listView.setAdapter(new Adapter_ListView_ware(IndexClothingActivity.this));
				listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
					@Override
					public void onItemClick(AdapterView<?> arg0, View arg1, int position, long arg3) {
						Intent intent = new Intent(IndexClothingActivity.this, BabyActivity.class);
