...
public class IndexEbookActivity extends Activity implements IXListViewListener {
	...
	private class WareTask extends AsyncTask<Void, Void, HashMap<String, Object>> {
		...
		protected void onPreExecute() {
			if (dialog==null) {
				dialog= ProgressDialog.show(IndexEbookActivity.this, "", "正在加载...");
				dialog.show();
			}
		}
		...
		protected void onPostExecute(HashMap<String, Object> result) {
			...
			if (result != null && result.get("data") != null) {
				...
				listView.setAdapter(new Adapter_ListView_ware(IndexEbookActivity.this, arrayList));
				listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
					@Override
					public void onItemClick(AdapterView<?> arg0, View arg1, int position, long arg3) {
						Intent intent = new Intent(IndexEbookActivity.this, BabyActivity.class);
						startActivity(intent);
					}
				});

			}else {
				listView.setAdapter(new Adapter_ListView_ware(IndexEbookActivity.this));
				listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
					@Override
					public void onItemClick(AdapterView<?> arg0, View arg1, int position, long arg3) {
						Intent intent = new Intent(IndexEbookActivity.this, BabyActivity.class);
